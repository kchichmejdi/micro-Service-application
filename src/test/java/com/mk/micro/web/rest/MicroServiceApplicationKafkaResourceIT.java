...
class MicroServiceApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        MicroServiceApplicationKafkaResource kafkaResource = new MicroServiceApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/micro-service-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/micro-service-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
